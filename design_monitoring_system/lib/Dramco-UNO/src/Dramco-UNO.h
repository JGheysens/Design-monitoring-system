...
class DramcoUnoClass {
	public:
		...
		// --- Sensors ---
		//external soil moisture & temperature sensor
		void sendSoilMoisture(float soilMoisture);
		void addSoilMoisture(float soilMoisture);
		void addSoilMoistureToMessage(float soilMoisture);
		void sendSoilTemperature(float soilTemperature);
		void addSoilTemperature(float soilTemperature);
		void addSoilTemperatureToMessage(float soilTemperature);

		//external rain sensor
		void sendRain(float rain);
		void addRain(float rain);
		void addRainToMessage(float rain);
		
		// external ultrasonic sensor
		void sendUltrasonic(float ultrasonic);
		void addUltrasonic(float ultrasonic);
		void addUltrasonicToMessage(float ultrasonic);
